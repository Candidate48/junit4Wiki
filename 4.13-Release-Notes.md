...
To ensure serializability of further changes in the test class (until excising these fields by a major rev), a unit test now runs against v4.11, v4.12 failures, asserting around `ArrayAssertionFailure#toString/getCause()`.
