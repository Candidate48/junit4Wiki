...
## [Pull request #549:](https://github.com/junit-team/junit/pull/549) `@DataPoints`-annotated methods can now yield `null` values
...
## [Pull request #564:](https://github.com/junit-team/junit/pull/564) Allow configurable creation of child runners of parameterized suites
...
## [Pull request #583:](https://github.com/junit-team/junit/pull/583) ExpectedException now fails when an AssertionError is expected but not thrown
