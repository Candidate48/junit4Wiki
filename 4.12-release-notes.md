...
```
## [Pull request #601:](https://github.com/KentBeck/junit/pull/601) Allow use of Assume in tests run by Theories runner
...
## [Pull request #623:](https://github.com/KentBeck/junit/pull/623) Ensure datapoints array fields and methods are public and static in Theory classes.
