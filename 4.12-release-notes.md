...
Clone the project (git clone https://github.com/KentBeck/junit.git) and navigate to the project root on your local system (cd junit).
...
Activating and deactivating Maven profiles in Integrated Development Environments:

[http://www.jetbrains.com/idea/webhelp/activating-and-deactivating-maven-profiles.html](http://www.jetbrains.com/idea/webhelp/activating-and-deactivating-maven-profiles.html)

In the Eclipse, _Run -> Run As -> 2 Maven build..._ open the popup _Edit Configuration_ and specify the profiles.


## [Pull request #611:](https://github.com/KentBeck/junit/pull/611) Assert.assertNotEquals() for float parameters.
...
## [Pull request #607:](https://github.com/KentBeck/junit/pull/607) Improving theory failure messages
